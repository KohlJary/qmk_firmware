...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LYB] = LAYOUT_ansi_89(
        ...
        _______,  QK_LEAD,  KC_1,    KC_2,    KC_3,     KC_4,      KC_5,    KC_6,     KC_7,    KC_8,     KC_9,     KC_0,     KC_AT,    KC_DLR,   KC_CAPS,           TD(T_CP),
    ...
    [LY1] = LAYOUT_ansi_89(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,   _______,     _______,  _______,  _______,  _______,   KC_PERC,  KC_AMPR,  _______,            _______,
