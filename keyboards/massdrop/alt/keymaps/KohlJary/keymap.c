...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_B] = LAYOUT_65_ansi_blocker(
        ...
        KC_LSFT,        KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, SLSH_BS,  LT(L_2,KC_TAB),       KC_UP,       TD(T_UD),
        MO(L_1), TG(L_I), KC_MEH,                 KC_SPC,                          TD(T_NS), TD(T_DR),    KC_LEFT, KC_DOWN,     KC_RGHT
    ),
    ...
    [L_G] = LAYOUT_65_ansi_blocker(
        ...
        KC_LSFT, KC_Z,    KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH,          KC_GRV,  KC_UP,   TD(T_UD),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
        ...
        case RGB_TOG:
            ...
            return false;
        default:
            return process_record_user_keycodes(keycode, record); //Process all other keycodes normally
    }
}
