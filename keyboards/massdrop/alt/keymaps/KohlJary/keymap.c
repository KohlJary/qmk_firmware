...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_B] = LAYOUT_65_ansi_blocker(
        G(KC_GRV),     KC_1,         KC_2,         KC_3, KC_4, KC_5, KC_6, KC_7, KC_8,    KC_9,         KC_0,         TD(T_AO),     TD(T_EQ), CW_TOGG, TG(L_G),
    ...
    [L_1] = LAYOUT_65_ansi_blocker(
        ...
        CW_TOGG, S(KC_6), S(KC_5), S(KC_4),   S(KC_9),    S(KC_0),    KC_LEFT, KC_DOWN,  KC_UP,   KC_RGHT, KC_EQL,    S(KC_MINS),        _______,  _______,
