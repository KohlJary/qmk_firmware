...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_B] = LAYOUT_65_ansi_blocker(
        ...
        GUI_T(KC_DEL),   KC_Q,         KC_W,         KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I,    KC_O,           KC_P,           KC_LBRC, KC_RBRC, KC_BSLS, KC_VOLD,
    ...
    [L_1] = LAYOUT_65_ansi_blocker(
        ...
        _______, S(KC_1), S(KC_2), S(KC_3),   S(KC_LBRC), S(KC_RBRC), _______, _______, LAMBDA,  AND_OR,  EQ_NEQ,  BRACES,  PARBRA,  TG(L_I),    KC_WH_U,
        _______, S(KC_6), S(KC_5), S(KC_4),   S(KC_9),    S(KC_0),    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_MINS, KC_EQL,           G(KC_QUOT), KC_WH_D,
        _______, S(KC_7), S(KC_8), S(KC_GRV), KC_LBRC,    KC_RBRC,    KC_BSPC, KC_DEL,  ELPS,    _______, KC_BSLS,          KC_BTN1, KC_MS_U,    KC_BTN2,
