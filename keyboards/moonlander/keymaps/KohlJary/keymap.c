...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [L_B] = LAYOUT_moonlander(
        G(KC_GRV),     KC_1,    KC_2,    KC_3,    KC_4,    KC_5, G(KC_P),       G(KC_N),  KC_6, KC_7,    KC_8,    KC_9,   KC_0,    T_RSTRT,
    ...
    [L_1] = LAYOUT_moonlander(
        ...
        _______,     KC_EXLM,    KC_AT,      KC_HASH,   KC_ASTR,    LTE_GTE,    LAMBDA,               TD(T_IN), KC_MS_L,    KC_MS_D,    KC_MS_U,    KC_MS_R,    KC_PGUP,    _______,
        _______,     KC_CIRC,    KC_PERC,    KC_DLR,    KC_LBRC,    KC_RBRC,    KC_F24,               _______,  KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,   KC_HOME,    ALT_T(KC_END),
        KC_VOLU,     _______,    _______,    _______,   KC_PLUS,    KC_TILD,                                    _______,    _______,    _______,    TD(T_DR),   KC_PGDN,    _______,
        KC_VOLD,     KC_MUTE,    KC_MPRV,    KC_MPLY,   KC_MNXT,                _______,              _______,              _______,    _______,    _______,    _______,    TG(L_F),
                                                        _______,    _______,    _______,              _______,  QK_AREP,    QK_REP
    ),
