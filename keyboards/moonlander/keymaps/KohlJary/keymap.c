...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [L_B] = LAYOUT_moonlander(
        G(KC_GRV),     KC_1,    KC_2,    KC_3,    KC_4,    KC_5, _______,       _______,  KC_6, KC_7,    KC_8,    KC_9,   KC_0,    T_RSTRT,
        GUI_T(KC_EQL), KC_Q,    KC_W,    KC_E,    KC_R,    KC_T, EQ_NEQ,        AND_OR,   KC_Y, KC_U,    KC_I,    KC_O,   KC_P,    GUI_T(KC_MINS),
        TD(T_CE),      KC_A,    KC_S,    KC_D,    KC_F,    KC_G, QK_LEAD,       TD(T_BR), KC_H, KC_J,    KC_K,    KC_L,   KC_SCLN, ALT_T(KC_QUOT),
        TD(T_LS),      KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                          KC_N, KC_M,    KC_COMM, KC_DOT, SLSH_BS, TD(T_RS),
        KC_CALC,       _______, KC_MPRV, KC_MPLY, KC_MNXT,       G(KC_SPC),     G(KC_ENT),      KC_LEFT, KC_DOWN, KC_UP,  KC_RGHT, TG(L_G),
    ...
    [L_1] = LAYOUT_moonlander(
        ...
        _______,     KC_EXLM,    KC_AT,      KC_HASH,   KC_ASTR,    LTE_GTE,    LAMBDA,               TD(T_IN), KC_MS_L,    KC_MS_D,    KC_MS_U,    KC_MS_R,    KC_PGUP,    GUI_T(KC_PGDN),
        _______,     KC_CIRC,    KC_PERC,    KC_DLR,    KC_LBRC,    KC_RBRC,    KC_F24,               _______,  KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,   KC_HOME,    ALT_T(KC_END),
        _______,     _______,    _______,    _______,   KC_PLUS,    KC_TILD,                                    _______,    _______,    _______,    TD(T_DR),   _______,    _______,
        _______,     _______,    KC_VOLD,    KC_MUTE,   KC_VOLU,                _______,              _______,              _______,    _______,    _______,    _______,    TG(L_F),
                                                        _______,    _______,    KC_F24,               _______,  QK_AREP,    QK_REP
    ),

    [L_2] = LAYOUT_moonlander(
        _______, RGB_HUD, RGB_HUI,  RGB_SAD, RGB_SAI, RGB_VAD, RGB_VAI,      KC_F18,  KC_F19,  KC_F20,  KC_F21,  KC_F22,  KC_F23,  _______,
